import { GraduationCap, PencilSparkles, Plus } from 'lucide-react'
import React from 'react'
import { UseAdmin } from '../../context/AdminContext'

const Skills = () => {
  const { admin } = UseAdmin()
  console.log(admin.about.skills)
  return (
    <div className='relative w-full h-screen flex flex-col justify-center items-center'>
      ...
      <div className='MainContent w-full h-[92%] flex flex-col justify-center items-center'>
        {
          admin?.about?.skills?.length === 0 ? (<span className='flex items-center justify-center gap-2 text-xl font-semibold text-black/20 italic relative border border-dashed border-black/20 p-[9px_24px]'>No Skills Found <PencilSparkles className='text-black/20' /> 
