import { BookOpen, PencilSparkles, Plus } from 'lucide-react'
  ...
  return (
    <div className='relative w-full h-screen flex flex-col justify-center items-center'>
      <div className='TopBar w-full h-[8%] border-b border-[#0000009b] flex items-center justify-between px-[28px]'>
        <span className='flex items-center justify-center gap-2 text-xl font-semibold'><BookOpen size={30} /> Education</span>
        {/* Add Skill Button */}
      ...
      <div className='MainContent w-full h-[92%] flex flex-col justify-center items-center'>
        {
          admin?.about?.education?.length === 0 ? (<span className='flex items-center justify-center gap-2 text-xl font-semibold text-black/20 italic relative border border-dashed border-black/20 p-[9px_24px]'>No Education Found <PencilSparkles className='text-black/20' /> 
