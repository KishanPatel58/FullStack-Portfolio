import { FolderGit2, PencilSparkles, Plus } from 'lucide-react'
  ...
  return (
    <div className='relative w-full h-screen flex flex-col justify-center items-center'>
      <div className='TopBar w-full h-[8%] border-b border-[#0000009b] flex items-center justify-between px-[28px]'>
        <span className='flex items-center justify-center gap-2 text-xl font-semibold'><FolderGit2 size={30} /> Projects</span>
        {/* Add Skill Button */}
      ...
      <div className='MainContent w-full h-[92%] flex flex-col justify-center items-center'>
        {
          admin?.about?.projects?.length === 0 ? (<span className='flex items-center justify-center gap-2 text-xl font-semibold text-black/20 italic relative border border-dashed border-black/20 p-[9px_24px]'>No Projects Found <PencilSparkles className='text-black/20' /> 
